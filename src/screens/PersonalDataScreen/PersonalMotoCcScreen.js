...
class PersonalMotoCcScreen extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  componentWillMount() {
    ...
    let moto_cc_possibilities = this.props.loginState.moto_properties
      .moto_cc_possibilities;
  ...
  handleMotoCCChange = val => {
    const filtered_moto_m_v = this.props.registerState.get_mobility_moto_values.filter(
      e => {
        return (
          e.year == this.props.loginState.moto_properties.moto_year &&
          e.engine ==
            this.props.loginState.moto_properties.moto_engine_answer &&
          e.type == val
        );
      }
    );
          ...
          >
            ...
            <View style={[styles.buttonContainer]}>
              ...
              <TouchableWithoutFeedback
                onPress={() => {
                  if (
                    this.props.loginState.infoProfile.moto != undefined &&
                    this.props.loginState.infoProfile.moto != null
                  )
...
export default withData(PersonalMotoCcScreen);
