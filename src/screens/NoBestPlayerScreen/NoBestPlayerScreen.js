...
class NoBestPlayerScreen extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      refreshing: false
    ...
    return (
      ...
      >
        ...
        <View style={styles.subView}>
          <Text style={styles.textTitle}>  {strings('id_2_12')}</Text>
        ...
        <View style={styles.space}></View>
        <Image
          source={require("./../../assets/images/best_players_empty.png")}
...
export default NoBestPlayerScreen;
