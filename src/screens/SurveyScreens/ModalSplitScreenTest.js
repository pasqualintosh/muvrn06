...
class ModalSplitScreenTest extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      values: [
      ...
      >
        ...
        >
          ...
          <View style={styles.textHeaderContainer}>
            ...
            <Text style={styles.textHeader}>{strings("choose_your_tra")}</Text>
          </View>
        </View>
        <View
          style={{
...
export default withData(ModalSplitScreenTest);
