...
class SurveyWebView extends React.Component {
  ...
  renderItWebView() {
    ...
    let addHandleFinish = `document.querySelectorAll("div").forEach(function(e){if(e.innerHTML.includes("Invia")){if(e.parentElement.parentElement.parentElement!=null&&e.parentElement.parentElement.parentElement.nodeName=="BUTTON"){e.parentElement.parentElement.parentElement.addEventListener("click", function(){window.ReactNativeWebView.postMessage(document.cookie='completed=true')})}}})`;
  ...
  renderEsWebView() {
    let removePowered = `setInterval(function(){document.querySelectorAll("div").forEach(function(e){if(e.innerHTML.includes("Powered by")&&e.hasAttribute("font-weight")){e.parentElement.parentElement.parentElement.parentElement.style.display="none"}})},1000)`;
    let addHandleFinish = `document.querySelectorAll("div").forEach(function(e){if(e.innerHTML.includes("Enviar")){if(e.parentElement.parentElement.parentElement!=null&&e.parentElement.parentElement.parentElement.nodeName=="BUTTON"){e.parentElement.parentElement.parentElement.addEventListener("click", function(){window.ReactNativeWebView.postMessage(document.cookie='completed=true')})}}})`;
    let finalScript = `${removePowered};${addHandleFinish};`;
    return (
      <WebView
        onLoadEnd={() => {
        ...
        source={{
          // uri: `http://www.google.com`
          // uri: `https://push564474.typeform.com/to/vBODOz`
          uri: `https://push564474.typeform.com/to/lmCm8m?email=${this.props.loginState.username}`
        }}
        style={{
          display: !this.state.can_render ? "none" : "flex"
        }}
  ...
  renderEnWebView() {
    let removePowered = `setInterval(function(){document.querySelectorAll("div").forEach(function(e){if(e.innerHTML.includes("Powered by")&&e.hasAttribute("font-weight")){e.parentElement.parentElement.parentElement.parentElement.style.display="none"}})},1000)`;
    let addHandleFinish = `document.querySelectorAll("div").forEach(function(e){if(e.innerHTML.includes("Submit")){if(e.parentElement.parentElement.parentElement!=null&&e.parentElement.parentElement.parentElement.nodeName=="BUTTON"){e.parentElement.parentElement.parentElement.addEventListener("click", function(){window.ReactNativeWebView.postMessage(document.cookie='completed=true')})}}})`;
    let finalScript = `${removePowered};${addHandleFinish};`;
    return (
      <WebView
        onLoadEnd={() => {
