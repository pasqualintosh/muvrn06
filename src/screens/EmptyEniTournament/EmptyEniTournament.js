...
class EmptyEniTournament extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      refreshing: false
      ...
      >
        ...
        >
          ...
          >
            ...
            <Image
              source={require("./../../assets/images/tournament_eni.png")}
              style={styles.imageLogo}
            />
            {/* <View style={styles.space}></View> */}
            <View style={styles.subView}>
              <Text style={styles.textTournament}>{strings("id_2_03")}</Text>
            </View>
          </ImageBackground>
        </LinearGradient>
      </ScrollView>
...
export default EmptyEniTournament;
