...
class DetailSponsorTournamentScreen extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      >
        <StatusBar backgroundColor={"#007DC5"} barStyle="light-content" />
        ...
        >
          <LinearGradient
            ...
            colors={[
              "#007DC5",
              Platform.OS === "android" ? "#014fa0" : "#0C519E"
            ]}
            style={{
              width: Dimensions.get("window").width,
          ...
          >
            <Animated.View
              style={{
                ...
                height: Platform.OS === "android" ? 150 : 210
              }}
            >
              <Animated.Image
                style={{
                  width: Platform.OS === "android" ? 116 : 149,
        ...
        <Animated.Image
          ...
          source={require("../../assets/images/wave/wave_sponsor.png")}
        />
        <View
          style={{
            height: 30,
...
export default DetailSponsorTournamentScreen;
