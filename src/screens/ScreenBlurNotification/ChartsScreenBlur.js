...
class ChartsScreenBlur extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentWillMount() {
    Tracker.trackScreenView("ChartsScreenBlur.js");
    trackScreenView("ChartsScreenBlur.js");
...
export default ChartsScreenBlur;
