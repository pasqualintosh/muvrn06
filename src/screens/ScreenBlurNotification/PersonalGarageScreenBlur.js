...
import PersonalGarageScreen from "../../screens/PersonalGarageScreen/PersonalGarageScreen";
...
class PersonalGarageScreenBlur extends React.PureComponent {
  constructor(props) {
    super(props);
...
export default PersonalGarageScreenBlur;
