...
import DetailSponsorScreen from "../DetailSponsorScreen/DetailSponsorScreen";
...
class DetailSponsorScreenBlur extends React.Component {
  constructor(props) {
    super(props);
...
export default DetailSponsorScreenBlur;
