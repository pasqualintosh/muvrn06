...
class PersonalGarageScreen extends React.Component {
  constructor() {
    super();
    this.state = {
    ...
    return (
      ...
      >
        ...
        <View
          ...
          <View style={styles.space}></View>
          <Image
            source={require("./../../assets/images/grarage_illustration.png")}
          ...
          >
            <Image
              source={require("./../../assets/images/add_pink_icn.png")}
              style={styles.buttonImageStyle}
            />
          </TouchableOpacity>
          </ImageBackground>
...
export default withData(PersonalGarageScreen);
