...
class NoFinalScreen extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      refreshing: false
    ...
    return (
      ...
      >
          ...
          <View style={styles.subView}>
            <Text style={styles.textTitle}>{strings('id_2_15')}</Text>
          ...
          <View style={styles.space}></View>
          <Image
            source={require("./../../assets/images/finals_empty.png")}
