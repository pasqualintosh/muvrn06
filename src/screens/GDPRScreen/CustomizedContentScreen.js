...
class CustomizedContentScreen extends React.Component {
  ...
  nextGDPR = (status = false) => {
    ...
    //   })
    // );
    this.props.navigation.navigate("MailingListScreen");
  };

  
  videoGDPR = () => {
    this.props.navigation.navigate("GDPRVideoScreen", { typeGDPR: 'CustomizedContentScreen'});
  };
          ...
          >
            ...
            >
              <Text style={styles.textFooterBold}>
                {strings("commercially_us")}
              </Text>
            </View>
            <View />
            <Text style={styles.textFooter}>{strings("i_consent_that_")}</Text>
          </View>
          <OwnIcon
            name="onboarding-gdpr-joypad"
            size={200}
            color="#000000"
...
export default GDPR(CustomizedContentScreen);
