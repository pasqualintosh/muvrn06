...
class CommerciallyScreen extends React.Component {
  ...
  nextGDPR = (status = false) => {
    ...
    //   })
    // );
    this.props.navigation.navigate("SponsorshipScreen");
  };
          ...
          >
            ...
            >
              <Text style={styles.textFooterBold}>
                {strings("_585_customized_cont")}
              </Text>
            </View>
            <View />
            <Text style={styles.textFooter}>{strings("i_consent_to_re")}</Text>
          </View>
          <OwnIcon
            name="onboarding-gdpr-pencil"
            size={200}
            color="#000000"
...
export default GDPR(CommerciallyScreen);
