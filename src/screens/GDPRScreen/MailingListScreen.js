...
class MailingListScreen extends React.Component {
  ...
  videoGDPR = () => {
    this.props.navigation.navigate("GDPRVideoScreen", { typeGDPR: 'MailingListScreen'});
  };
          ...
          >
            ...
            >
              <Text style={styles.textFooterBold}>
                {strings("mailing_list")}
              </Text>
            </View>
            <View />
            <Text style={styles.textFooter}>{strings("i_consent_to_be")}</Text>
          </View>
          <OwnIcon
            name="onboarding-gdpr-mailing"
            size={200}
            color="#000000"
...
export default GDPR(MailingListScreen);
