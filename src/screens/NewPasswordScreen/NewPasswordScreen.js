...
class NewPasswordScreen extends React.Component {
  ...
  componentDidMount() {
    ...
    Tracker.trackScreenView("NewPasswordScreen.js");
    trackScreenView("NewPasswordScreen.js");
  ...
  handlePassword2 = text => {
    ...
    */
    ...
    this.setState({
      password2: text,
      ValidationPassword2: length || RisValid,
      passwordKeystone: ""
    });
  };

  // il click al tasto send
  handleNewPassword = () => {
    Keyboard.dismiss();
    ...
    if (error_txt.length) {
      ...
      this.props.dispatch(transfertToMUV({ password }));
    }
  };
  ...
  handleShowPasswordTap2 = () => {
    const hide_password2 = !this.state.hide_password2;
    let hide_password_icon2 = "ios-eye-off";

    if (hide_password2) hide_password_icon2 = "ios-eye";

    this.setState({ hide_password2, hide_password_icon2 });
  };
          ...
          >
             ...
             <Animated.View style={{ 
              ...
              <View style={styles.icon}>
                ...
                <Image
                  source={require("../../assets/images/inser_new_password.png")}
                  style={{
              ...
              >
                ...
                <View style={styles.input}>
                  ...
                  <TextInput
                    ...
                    displayError={!this.state.ValidationPassword2}
                    errorStyle={{ color: "red" }}
                    errorMessage="Password is invalid"
                    style={styles.inputText}
                    secureTextEntry={this.state.hide_password2}
                    onChangeText={this.handlePassword2}
                    blurOnSubmit={true}
                    ref={input => this.refInput(input, "Password")}
                    returnKeyType={"done"}
                    onSubmitEditing={this.handleNewPassword}
                    selectionColor={"#ffffff"}
                    onFocus={() => {
                      this.setState({ placeholderPassword2: "" });
                    }}
                    onBlur={() => {
                      this.setState({
                        placeholderPassword2: strings("id_13_32")
                      });
                    }}
                  />
                  <TouchableWithoutFeedback
                    onPress={this.handleShowPasswordTap2}
                    style={{ paddingRight: 10, paddingLeft: 10 }}
                  >
                    <Icon
                      name={this.state.hide_password_icon2}
                      size={18}
                      color="#ffffff"
                      style={{ paddingRight: 10, paddingLeft: 10 }}
                    />
...
export default ConnectLogin(NewPasswordScreen);
