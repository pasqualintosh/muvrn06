...
class GameCompleteWeekTournamentScreen extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      index: 0,
  ...
  _onRefresh = () => {
    ...
    this.props.dispatch(
      getWeeklySingleMatch({
        match_id: this.state.match.season_match.season_match_id,
        start_match: this.state.match.season_match.start_match,
  ...
  componentWillMount() {
    const height =
      Dimensions.get("window").height * 0.14 > 150
        ? 150
        : Dimensions.get("window").height * 0.14 < 80
        ? 80
    ...
    if (match.season_match) {
      ...
      if (match_id) {
        this.props.dispatch(
          getWeeklySingleMatch({
            match_id,
            start_match: match.season_match.start_match,
            saveData: this.saveMatch,
            currentMatch: false
          })
        );
  ...
  changePage = index => {
    this.game.scrollToIndex({ index: this.limitIndex(index - 1) });
    this.setState({
      index: index - 1
    });
  };
  ...
  handleScrollHeader(event) {
    ...
    this.game.scrollToIndex({ index: this.limitIndex(index) });
    this.setState({
      index
    });
  }
  ...
  singlePage = (idHome, idAway) => {
    const WinHome =
      this.state.match.total_point_home >= this.state.match.total_point_away;
    return (
      <Aux>
        <ImageBackground
          source={require("./../../assets/images/wave/live_match_gray.png")}
        ...
        >
          ...
          >
            <View style={{ alignItems: "center", justifyContent: "center" }}>
              <Text
                style={[styles.nameWhiteText, { opacity: WinHome ? 1 : 0.7 }]}
              >
                {this.state.match.season_match.city_home.city_name.toUpperCase()}
              </Text>
              <Text
                style={[styles.levelWhiteText, { opacity: WinHome ? 1 : 0.7 }]}
              >
                {citiesDescription(
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                this.goToCity(
                  idHome,
                  this.state.match.season_match.city_home.city_name,
                  this.state.match.season_match.city_home.id
                )
              }
              // disabled={true}
            >
            ...
            <Text style={[styles.PointsText, { opacity: WinHome ? 1 : 0.7 }]}>
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                this.goToCity(
                  idAway,
                  this.state.match.season_match.city_away.city_name,
                  this.state.match.season_match.city_away.id
                )
              }
              // disabled={true}
            >
          ...
          <Aux>
              ...
              {this.state.match.weekly_user_standing_home ? (
                this.state.match.weekly_user_standing_home.first_pos ? (
                  <GameUserItem
                    ...
                    points={
                      this.state.match.weekly_user_standing_home.first_points
                    }
                    height={this.state.height}
              ...
              {this.state.match.weekly_user_standing_away ? (
                this.state.match.weekly_user_standing_away.first_pos ? (
                  <GameReverseUserItem
                    ...
                    points={
                      this.state.match.weekly_user_standing_away.first_points
                    }
                    height={this.state.height}
                    navigation={this.props.navigation}
                    idUser={this.state.infoProfile.user_id}
              ...
              {this.state.match.weekly_user_standing_home ? (
                this.state.match.weekly_user_standing_home.third_pos ? (
                  <GameUserItem
                    ...
                    points={
                      this.state.match.weekly_user_standing_home.third_points
                    }
                    height={this.state.height}
                    navigation={this.props.navigation}
                    idUser={this.state.infoProfile.user_id}
              ...
              {this.state.match.weekly_user_standing_away ? (
                this.state.match.weekly_user_standing_away.third_pos ? (
                  <GameReverseUserItem
                    ...
                    points={
                      this.state.match.weekly_user_standing_away.third_points
                    }
                    height={this.state.height}
                    navigation={this.props.navigation}
                    idUser={this.state.infoProfile.user_id}
            ...
            >
              <GameUserItem
                ...
                avatar={7}
                average={true}
                // navigation={this.moveMyTeamStandings}
                points={
                  this.state.match.weekly_user_standing_home
              ...
              <GameReverseUserItem
                ...
                avatar={8}
                average={true}
                // navigation={this.moveEnemyTeamStandings}
                points={
                  this.state.match.weekly_user_standing_away
...
export default withData(GameCompleteWeekTournamentScreen);
