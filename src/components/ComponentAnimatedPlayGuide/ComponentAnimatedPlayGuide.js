...
class ComponentAnimatedPlayGuide extends React.PureComponent {
  ...
  onClickAnimated = () => {
    ...
    this.props.changeGuide({ animated: true });
  };
      ...
      >
        ...
        <Animated.View
          style={{
            ...
            top: 10,
            left: 0,
            transform: [{ translateX: positionX2 }, { translateY: positionY1 }],
        ...
        <Animated.View
          style={{
            ...
            top: 10,
            left: 0,
            transform: [{ translateX: positionX2 }, { translateY: positionY3 }],
...
export default withTracking(ComponentAnimatedPlayGuide);
