...
class MUVForwardFeed extends React.PureComponent {
  constructor() {
    super();
  ...
  componentDidMount() {
    // this.props.infoProfile.id
    Tracker.trackEvent(
      "view_MUVForwardFeed_" + this.props.infoProfile.id % 2,
      "Utente_" + this.props.infoProfile.id
    );
    trackEvent("view_MUVForwardFeed", "Utente_" + this.props.infoProfile.id);
  }
  ...
  moveToScreen = () => {
    Tracker.trackEvent(
      "open_MUVForwardFeed_" + this.props.infoProfile.id % 2,
      "Utente_" + this.props.infoProfile.id
    );
    trackEvent("open_MUVForwardFeed_" + this.props.infoProfile.id % 2, "Utente_" + this.props.infoProfile.id);
    this.props.navigation.navigate("GenericWebViewScreen", {
      url: this.props.infoProfile.id % 2 ? "https://push564474.typeform.com/to/Z3gRzp" : "https://push564474.typeform.com/to/RS7bXM",
      titleUrl: "Mobility post covid",
      dataUrl: { email: this.props.infoProfile.email}
    });
  };
          ...
          <View style={styles.viewStyle}>
            ...
            >
              <Text style={styles.textTitle}>
                ...
                <Text style={styles.textModalSplit}>Mobility post covid</Text>
                {label}
              </Text>
            </View>
            <View
            ...
            >
              <Image
                source={require("../../assets/images/muvforward-feed.png")}
                style={{
                  width: Dimensions.get("window").width * 0.8,
            ...
            >
              {this.props.infoProfile.id % 2 ? (
                <View style={styles.textBottomTitle}>
                  <Text style={styles.textDescrBold}>
                    {strings("id_99_10")}
                  </Text>
                  <Text style={styles.textDescr}>{strings("id_99_11")}</Text>
                  <Text style={styles.textDescrBold}>
                    {strings("id_99_12")}
                  </Text>
                </View>
                ...
                <View style={styles.textBottomTitle}>
                  <Text style={styles.textDescr}>{strings("id_99_10")}</Text>

                  <Text style={styles.textDescr}>{strings("id_99_12")}</Text>
                </View>
              )}
            </View>
          </View>
...
export default withNavigation(MUVForwardFeed);
