...
// SvgCityPolygon componente per disegnare mediante svg il grafico a triangoli con le statistiche della città
...
import CityScreenCardsFooter from "./../CityScreenCardsFooter/CityScreenCardsFooter";
import OwnIcon from "./../OwnIcon/OwnIcon";


class SvgCityPolygon extends React.Component {
  render() {
    // x
