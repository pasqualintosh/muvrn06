...
import CarOwning from "../CarOwning/CarOwning";
import CarSegment from "../CarSegment/CarSegment";
import CarFuel from "../CarFuel/CarFuel";
import MotoOwning from "../MotoOwning/MotoOwning";
import MotoEngine from "../MotoEngine/MotoEngine";
import MotoCC from "../MotoCC/MotoCC";
...
class MobilityHabitsCarSlide extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      scrollEnabled: true,
...
// export default MobilityHabitsCarSlide;
...
export default withRegister(MobilityHabitsCarSlide);
