...
class SurveySelectAvatarRegister extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
        ...
        >
          ...
          >
            ...
            <Image
              ...
              source={
                this.props.selectedAvatar == item.index + 1
                  ? images[item.index + 1]
                  : images_bn[item.index + 1]
              }
            />
          </View>
        </TouchableWithoutFeedback>
...
export const AvatarList = (start = 0, end = 57) => {
  let avatars = [];
...
export default SurveySelectAvatarRegister;
