...
export const styles = StyleSheet.create({
  ...
  sponsorContainer: {
    ...
    width: Dimensions.get("window").width, flexDirection: "column", alignContent: "center", justifyContent: 'center', alignSelf: "center", backgroundColor: "#F7F8F9", paddingBottom: 15
  },
  globalSponsor: {
