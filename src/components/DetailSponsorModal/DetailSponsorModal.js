...
class DetailSponsorModal extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      sponsor: {}
  ...
  render() {
    ...
    return (
      ...
      >
      <Modal
          isVisible={this.props.activeSponsor}
          onBackdropPress={() => this.props.DeleteDescriptionIconModalSponsor()}
          onBackButtonPress={() => this.props.DeleteDescriptionIconModalSponsor()}
        >
