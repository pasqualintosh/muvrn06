...
class ComponentAnimatedStopWithAuto extends React.Component {
            ...
            >
              ...
              >
                <OwnIcon
                  ...
                  name={
                    "Carpooling" === this.state.type ? "play-icn" : "car_icn"
                  }
                  size={48}
                  color="#FFFFFF"
                />
...
export default withTracking(ComponentAnimatedStopWithAuto);
