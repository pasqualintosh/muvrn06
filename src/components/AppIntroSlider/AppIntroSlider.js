/**
 * modificato da https://github.com/Jacse/react-native-app-intro-slider
 * @author Jacse
 */
...
export default class AppIntroSlider extends React.Component {
  ...
  _renderItem = item => {
    ...
    const handleNextTap = () => this._onNextPress();
    const props = {
      ...item.item,
      bottomSpacer,
      topSpacer,
  ...
  _renderPagination = () => {
    ...
    if (this.props.bottomButton)
      return (
        <View
          style={[styles.paginationContainer, this.props.paginationContainer]}
        >
  ...
  _renderGoOnButton() {
    if (this.props.goOnButton)
      if (
        this.props.endSurveySlideButton == true &&
        this.state.activeIndex == this.props.endSurveySlideNumber
      )
        return (
          <View style={styles.buttonContainer}>
            ...
            >
              <View style={styles.buttonBox}>
                <Text style={styles.buttonGoOnText}>{strings("i_will")}</Text>
              </View>
            </TouchableWithoutFeedback>
          </View>
        );
        ...
        return (
          <View style={styles.buttonContainer}>
            <TouchableWithoutFeedback onPress={() => this._onNextPress()}>
              <View style={styles.buttonBox}>
