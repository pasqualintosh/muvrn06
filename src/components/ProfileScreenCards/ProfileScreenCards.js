...
class ProfileScreenCards extends React.Component {
  ...
  render() {
    ...
    const colorProfile = colorRGBA[this.props.role];
    const colorTitle = colorCircle[this.props.role];
    const colorName = colorText[this.props.role];
    ...
    if (this.props.indexRole.length) {
      this.props.indexRole.forEach(elem => {
        if (elem.modal === 1) {
        ...
        <CardFlip style={styles.cardContainer} ref={card => (this.card = card)}>
          ...
          >
            <View style={styles.contentContainer}>
              <ImageBackground
                source={backgroundImage[this.props.role]}
              ...
              >
                ...
                <Image
                  ...
                  source={
                    images[avatarId][this.props.role][
                      this.props.level_number - 1
                    ]
                  }
                />
              </ImageBackground>
        ...
        <CardFlip style={styles.cardContainer} ref={card => (this.card = card)}>
          ...
          >
            <View style={styles.contentContainer}>
              ...
              <ProfileScreenCardsFooter style={{ marginTop: 20 }} />
            </View>
          </TouchableOpacity>
          <TouchableOpacity
            activeOpacity={1}
        ...
        >
          ...
          {/* <View
            style={{
              ...
              width: 50,
              // right: -9
              right: Dimensions.get("window").width * 0.45 - 34
              // - 38
            }}
          >
            {/* <TouchableOpacity onPress={() => this.moveGlobalRanking()}>
                <View
                  style={{
                    flexDirection: "row",
                    alignContent: "center",
                ...
                >
                  <OwnIcon
                    name="rank_arrow_up_icn"
                    size={30}
                    color={"#87D99A"}
                    click={() => this.moveGlobalRanking()}
                  />
                  <OwnIcon
  ...
  return {
    ...
    role: state.login.role
      ? state.login.role.roleUser
        ...
        : 0
      : 0,
    indexRole: state.login.role ? state.login.role.indexRole : []
  };
});
