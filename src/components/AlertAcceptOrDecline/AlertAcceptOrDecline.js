...
class AlertAcceptOrDecline extends React.Component {
  constructor(props) {
    super(props);
  }
  ...
  alert = () => {
    return (
      ...
      >
        ...
        >
         <TouchableOpacity
            onPress={() => this.props.confermModal(this.props.type)}
          >
            <View
...
export default AlertAcceptOrDecline;
